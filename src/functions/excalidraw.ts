...
export async function openExcalidrawView(app: App, leaf: WorkspaceLeaf): Promise<void> {
...
export async function getExcalidrawPlugin(
  ...
  const excalidraw = pluginManager.plugins['obsidian-excalidraw-plugin'] as unknown as
    | ExcalidrawPlugin
    | undefined;
