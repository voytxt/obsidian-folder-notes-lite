...
export async function renderGeneral(settingsTab: SettingsTab): Promise<void> {
  ...
  nameSetting.infoEl.style.color =
    (settingsTab.app.vault.getConfig('accentColor') as string) || '#7d5bed';
  ...
  new Setting(containerEl)
    ...
    .addDropdown((dropdown) => {
      ...
      dropdown.setValue(defaultType).onChange(async (value: '.md' | '.canvas') => {
  ...
  templateSetting.infoEl.style.color =
    (settingsTab.app.vault.getConfig('accentColor') as string) || '#7d5bed';
  ...
  storageLocation.infoEl.style.color =
    (settingsTab.app.vault.getConfig('accentColor') as string) || '#7d5bed';
  ...
  fmtpSetting.infoEl.style.color =
    (settingsTab.app.vault.getConfig('accentColor') as string) || '#7d5bed';
